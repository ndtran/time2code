...
Time2Sport() {
    ...
    ###########
    ROCKETCHAT_CHANNEL='#notdev.time2sport'
    ROCKETCHAT_ALIAS='PADAWAN_BOT'
    ...
    # IMAGE URL
    ###########
    HOMER='https://seeklogo.com/images/H/homer-simpson-holding-beer-duff-logo-9172512EF9-seeklogo.com.png'
    MONDAY='https://imagenes.iberoeconomia.es/wp-content/uploads/2019/08/01132015/Anllela-Sagra-Entrenamiento-680x415.jpg'
    TUESDAY='https://scontent.fzrh3-1.fna.fbcdn.net/v/t1.0-9/67209405_1755104351258960_8649192620855132160_n.jpg?_nc_cat=111&_nc_sid=8024bb&_nc_oc=AQmdoPeQxpLFJF965i_SkuSbpNgKRPf_qdsL6xlf7Vo6hSHEci4qRgcBlyVODobQbsk&_nc_ht=scontent.fzrh3-1.fna&oh=4f1b39499e9467ed5985261007abab13&oe=5EBDCE4A'
    WEDNESDAY='https://4.bp.blogspot.com/-ERvQB3-ZA7g/ULpXgcepaII/AAAAAAAAAGk/6eryjv4OsOU/s1600/603585_421143197950736_1609725200_n.jpg'
    THURSDAY='http://2.bp.blogspot.com/-qnO7_78pnG4/VEMs6slyeYI/AAAAAAAAObs/MjtyAMeH6jg/s1600/ddddd.jpg'
    FRIDAY='https://suburbanmen.com/wp-content/uploads/2020/03/instagram-crush-meredith-mack-20200302-1006.jpg'

    # !! using sh and bash:array start with 0, using zsh:array start with 1 !!
    IMAGE_URL=($HOMER $MONDAY $TUESDAY $WEDNESDAY $THURSDAY $FRIDAY $HOMER)
    DAY=('SUNDAY' 'MONDAY' 'TUESDAY' 'WEDNESDAY' 'THURSDAY' 'FRIDAY' 'SATUDAY')
